            ...
            <header className="flex items-center justify-center w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-center w-full">
                <div className="header-row ">
                  <Img
                    className="common-pointer h-[51px]"
                ...
                <Button
                  className="common-pointer cursor-pointer font-semibold sm:hidden leading-[normal] min-w-[112px] md:ml-[0] ml-[25px] text-center text-sm"
              ...
              <div className="flex flex-col items-center justify-start rounded-[16px]">
                <div className="flex flex-col gap-9 items-start justify-start w-full">
                  <div className="flex flex-col gap-4 items-start justify-start w-full">
                    <TextArea
                      className="bg-transparent border-0 font-bold font-opensans leading-[normal] md:text-5xl text-[70px] placeholder:text-gray-902 text-gray-902 text-left w-full"
                      name="BestRestaurant"
